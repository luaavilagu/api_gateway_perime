...
export const createPublication = async (_, {input}, ctx) => {
    ...
    return await axios.put(`http://${ctx.PUBLICATION_URL}:${ctx.PUBLICATION_PORT}/${ctx.PUBLICATION_BASE_ENDPOINT}`, data, {headers: {'Content-Type': 'application/json'}}).then(res => res.data)
}
